...
MainGui := Gui("-MinimizeBox +Owner" EnvGet('np2_hwnd'), "MsgBox Creator for AHK v2")
...
MainGui.Add("Button", "x430 y345 h45 w100 Default", "&Insert into`nNotepad2").OnEvent("Click", InsertCode)
...
MainGui.SetFont(, "JetBrains Mono") ; preferred
MainGui.Add("Edit", "xs+10 ys+20 w590 r4 vFunctionText")
...
InsertCode(thisCtrl, *) {
	...
	thisCtrl.Gui.Destroy()
	try {
		hSci := ControlGetHwnd('Scintilla1', 'ahk_id' EnvGet('np2_hwnd'))
		Scintilla(hSci).AddText(saved.FunctionText)
	}
}
